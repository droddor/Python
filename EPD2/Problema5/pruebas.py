...
#Probamos diccionario con key y valores (tuplas)
    iContador = 0
    for sKey,tVino in dVinos.items():
        if iContador >= 5:
            break
        print(f"{sKey},{tVino}\n")
        iContador += 1
...
print("="*10 + "CON ITERTOOLS" + "="*10)

for sKey,tVino in itertools.islice(dVinos.items(), 10):
    print(f"{sKey},{tVino}")


clave = "Vermentino 2017"
